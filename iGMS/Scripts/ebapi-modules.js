var Rho = Rho || (function(Q) {
    ...
    var v = "0";
    var af = {
        isFunction: function(i) { return "function" === typeof i },
        isPlainObject: function(i) { return i && "object" === typeof i },
        isArray: function(i) { return (i && "Array" == (i).constructor.name) },
        extend: function() {
            ...
            if (typeof at !== "object" && !af.isFunction(at)) { at = {} }
            if (ar === aq) {
                at = this;
                ar--
            }
                ...
                if ((ax = arguments[ar]) != null) {
                    for (ap in ax) {
                        ...
                        if (aw && ao && (af.isPlainObject(ao) || (au = af.isArray(ao)))) {
                            ...
                            } else { av = an && af.isPlainObject(an) ? an : {} }
                            at[ap] = af.extend(aw, av, ao)
                        } else { if (ao !== undefined) { at[ap] = ao } }
                    }
                }
            }
            return at
        ...
        ajax: function(aq) {
            ...
            function ao() { if (typeof XMLHttpRequest !== "undefined") { return new XMLHttpRequest() } else { var au = ["MSXML2.XmlHttp.5.0", "MSXML2.XmlHttp.4.0", "MSXML2.XmlHttp.3.0", "MSXML2.XmlHttp.2.0", "Microsoft.XmlHttp"]; for (var aw = 0, at = au.length; aw < at; aw++) { try { return new ActiveXObject(au[aw]) } catch (av) {} } } return null }
            var ar = ao();

            function i(at) {
                return function() {
                    if (at.readyState < 4) { return }
                    if (at.status !== 200 && at.status !== 0) {
                        (aq.error || function() {})(at, "error", at.statusText);
                        return
                    }
                    if (at.readyState === 4) { var av = null; try { av = JSON.parse(at.responseText) } catch (au) {}(aq.success || function() {})(av, "success", at) }
                }
            }
            if (aq.async === true) { ar.onreadystatechange = i(ar) }
            ar.open(aq.type || "get", aq.url || "", aq.async === true);
            var ap = aq.headers || {};
            for (var an in ap) {
                if (!ap.hasOwnProperty(an)) { continue }
                ar.setRequestHeader(an, ap[an])
            }
            ar.send(aq.data);
            if (aq.async !== true) { i(ar)() }
        },
        each: function(an, ao) { if (this.isArray(an)) { an.forEach(function(aq, ap) { ao(ap, aq) }) } else { for (var i in an) { if (an.hasOwnProperty(i)) { ao(i, an[i]) } } } }
    };
    var M = 0;
    var y = {};

    function ab() { return window.__rhoJsVmID || null }

    function t() {}

    function b(i) { if ("undefined" == typeof i || !i) { i = W } return (i + "#" + M++) }

    function F(i) { if (i && "string" == typeof i) { return (i.toLowerCase() == "true") } return false }

    function h(ap, an, ao) {
        if ("string" == typeof ap) { return ap }
        if ("function" != typeof ap) { ap = t }
        if ("undefined" == typeof ao || !ao) { ao = b() }
        var i = { id: ao, callback: ap, isPersistent: ("undefined" != typeof an) && an };
        y[ao] = i;
        return w + ao
    }

    function R(i) { for (var an in i) { if (!i.hasOwnProperty(an)) { continue } if ("object" == typeof i[an]) { i[an] = s(i[an]) } } return i }

    function s(i) { if ((i != null) && ("object" == typeof i)) { if (i[W] && i[am]) { return N(i[am], i[W]) } else { return R(i) } } return i }

    function l(i) { if ("undefined" == typeof i) { throw "Invalid API JSON response" } if (null == i || "object" != typeof i) { return i } var an = af.extend(i instanceof Array ? [] : {}, i); return s(an) }

    function e(ap) { var ao = {}; if ("string" == typeof ap) { ap = ap.split(/[\s\,]/) } if (ap instanceof Array) { for (var an = 0; an < ap.length; an++) { if (0 < ap[an].length) { ao[ap[an]] = null } } } else { if (ap instanceof Object) { ao = ap } } return ao }

    function U(aq) { var ap = []; if ("string" == typeof aq) { aq = aq.split(/[\s\,]/) } if (aq instanceof Array) { for (var ao = 0; ao < aq.length; ao++) { if (0 < aq[ao].length) { ap.push(aq[ao]) } } } else { if (aq instanceof Object) { for (var an in aq) { if (aq.hasOwnProperty(an) && 0 < an.length) { ap.push(an) } } } } return ap }
    var ai = 0;

    function p(i, an) { if ("function" != typeof an) { return an } return G + ":" + h(an, true) }

    function O(ap) {
        var aq = null;
        if ("number" == typeof ap.valueCallbackIndex) { if (ap.valueCallbackIndex < ap.args.length - 1) { throw "Generated API method error: wrong position for value callback argument!" } if (ap.valueCallbackIndex == ap.args.length - 1) { aq = ap.args.pop() } if (aq && "function" != typeof aq) { throw "Value callback should be a function!" } }
        var au = null;
        var ao = null;
        if ("number" == typeof ap.persistentCallbackIndex) {
            if (ap.persistentCallbackIndex < ap.args.length - 2) { throw "Generated API method error: wrong position for persistent callback argument!" }
            if (ap.persistentCallbackIndex == ap.args.length - 2) {
                ao = ap.args.pop();
                au = ap.args.pop()
            } else { if (ap.persistentCallbackIndex == ap.args.length - 1) { au = ap.args.pop() } }
            if (au && "function" != typeof au) { throw "Persistent callback should be a function!" }
            if (ao && "string" != typeof ao) { throw "Persistent callback optional parameters should be a string!" }
            var ao = ao || null;
            if (au) { au = h(au, true) }
        }
        var an = { method: ap.method, params: ap.args };
        an[am] = ap.module;
        an[W] = ap.instanceId || null;
        an.jsonrpc = "2.0";
        an.id = ai++;
        if (au) { an[G] = { id: au, vmID: ab(), optParams: ao } }
        var ar = JSON.stringify(an, p);
        var av = null;

        function at(aw) { av = l(aw); if (aq) { aq(av) } }

        function i(aw) { throw aw.message }
        Rho.platform.nativeApiCall(ar, null != aq, function(aw) { if (aw.error) { i(aw.error) } else { at(aw.result) } });
    ...
    function ag(i) {
        return function(an) {
            ...
            if ("getProperties" == an.method && 0 < an.args.length) { an.args[0] = U(an.args[0]) }
            an.module = i;
            an.method = an.method;
            return O(an)
        }
    ...
    function Z(i, aq, ap) {
        ...
        if ("function" == typeof ar) {
            if ("function" == typeof au && !ap) { throw "Namespace definition conflict!" }
            ao = true;
            ar = i;
            au = aq
        }
        for (var at in ar) {
            if (!ar.hasOwnProperty(at)) { continue }
            if (au.hasOwnProperty(at) && !ap) { continue }
            if ("prototype" == at) {
                if (ao) { continue }
                if ("object" != typeof au[at]) { au[at] = {} }
                for (var an in ar[at]) {
                    if (!ar[at].hasOwnProperty(an)) { continue }
                    au[at][an] = ar[at][an]
                }
                continue
            }
    ...
    function aa(au, at, an) {
        ...
        for (var aq = 0; aq < ap.length; aq++) {
            ...
            aw = aw + (aq == 0 ? "" : ".") + ao;
            var ar = av[ao];
            if (!(ar instanceof Object || "undefined" == typeof ar)) { throw "Namespace " + aw + " is already defined and it isn't an object!" }
            if (aq == ap.length - 1) { if (av[ao]) { av[ao] = Z(av[ao], at, an) } else { av[ao] = at } }
            av[ao] = av[ao] || {};
            av = av[ao]
        }
        return av
    }
    var P = { ffHackKeywords: false, ffHackMethod: false, js185: false };
    (function z() {
        P.ffHackKeywords = (function an() {
            ...
            var at = false;
            try {
                aq = {get propGet() { ap = true; return ap }, set propSet(au) { at = au } };
        ...
        P.ffHackMethod = (function ao() {
            ...
            var at = false;
            try {
                aq.__defineGetter__("propGet", function() { ap = true; return ap });
                aq.__defineSetter__("propSet", function(au) { at = au });
                aq.propSet = aq.propGet
            } catch (ar) {}
            return ap && at
        })();
        P.js185 = (function i() {
            ...
            var at = false;
            try {
                Object.defineProperty(aq, "propGet", { get: function() { ap = true; return ap } });
                Object.defineProperty(aq, "propSet", { set: function(au) { at = au } });
                aq.propSet = aq.propGet
            } catch (ar) {}
            return ap && at
        })()
    ...
    var n = function(ap, ar, i, aq) {
        ...
        function an(at, ay) { var ax = ay.split(":"); var aw = ax[0]; var av = ax[1]; var au = ax[2]; if (("get" == at) && av) { return av } if (("set" == at) && au) { return au } return at + aw.charAt(0).toUpperCase() + aw.slice(1) }
        if (null != i && "function" == typeof i) { ap[an("get", ar)] = i }
        if (null != aq && "function" == typeof aq) { ap[an("set", ar)] = aq }
    };
    var a = n;
    if (P.js185) {
        a = function(ap, ar, i, aq) {
            var ao = ar.split(":")[0];
            var an = { configurable: true, enumerable: false };
            if (null != i && "function" == typeof i) { an.get = i }
            if (null != aq && "function" == typeof aq) { an.set = aq }
    ...
    function m(aq, ap, an, i, at) {
        ...
        var ao = ap;
        var au = ap + "=";
        if (2 < av.length) { au = av[2] }
        if (1 < av.length) { ao = av[1] }
        return function() { try { if ("function" == typeof at) { return at.apply(this, arguments) } } catch (aw) { throw "Custom accessor function exception: " + aw } return aq({ instanceId: ("function" == typeof i) ? i.apply(this, []) : v, args: arguments, method: ar ? au : ao, valueCallbackIndex: (ar ? 1 : 0) }) }
    }
    var u = [];

    function r(ap, aw, ar, an) {
        if (!(aw instanceof Array)) { throw "Property definitions list should be Array instance" }
        for (var aq = 0; aq < aw.length; aq++) {
            ...
            try { a(ap, ax.propName, av, ao) } catch (at) { u.push(name) }
            n(ap, ax.propName, av, ao)
        }
    }

    function D(ar, ap, aq) { if (!(ap instanceof Array)) { throw "Property definitions list should be Array instance" } if (a != n || true == aq) { for (var ao = 0; ao < ap.length; ao++) { var at = ap[ao]; try { a(ar, at.propName, at.propGetter, at.propSetter) } catch (an) { u.push(name) } } } }

    function d(aq, an, ap, i, ao) { return function() { return i({ instanceId: ("function" == typeof ao) ? ao.apply(this, []) : v, args: arguments, method: aq, persistentCallbackIndex: an, valueCallbackIndex: ap }) } }

    function aj(ar, au, an, aq) { if (!(au instanceof Array)) { throw "Property definitions list should be Array instance" } for (var ap = 0; ap < au.length; ap++) { var at = au[ap]; try { ar[at.methodName] = d(at.nativeName, at.persistentCallbackIndex, at.valueCallbackIndex, an, aq) } catch (ao) { u.push(at.methodName) } } }

    function k(ao, an, i) {
        if (!an) { throw "No parent namespace for alias!" }
        if (an[i]) { throw "Alias definition conflict!" }
        an[i] = ao
    }
    ...
    function x(ap, ao, i) {
        ...
        for (var an in i) {
            if (!i.hasOwnProperty(an)) { continue }
            aq.setAttribute(an, i[an])
        }
        ap.appendChild(aq)
    }

    function E(i) { x(document.getElementsByTagName("head")[0], "link", { rel: "stylesheet", href: i }) }

    function j(i) { x(document.getElementsByTagName("head")[0], "script", { type: "text/javascript", src: i }) }

    function c(aq) { var ar = null; var an = document.getElementsByTagName("script"); for (var ap = 0; ap < an.length; ap++) { var ao = (an[ap].getAttribute("src") || "").replace(/\?.*$/gi, ""); if (ao.indexOf(aq, ao.length - aq.length) !== -1) { ar = an[ap]; break } } return ar }
    var L = c(Y);

    function ak(i) {
        if (null == L || null == i || !i) { return }
    ...
    function I(an) {
        if (null == an) { return }
        var ao = [];
        if ("object" == typeof an && "Array" == an.constructor.name) { ao = an }
        if ("string" == typeof an) { ao = an.trim().split(/[,\s]+/) }
    ...
    if (null != L) { I(L.getAttribute("data-api-modules")) }
    ...
    function q(ar, an) {
        ...
        if ("object" == typeof aq && aq) {
            if ("function" == typeof aq.callback) {
                var i = null;
                var ap = null;
                if (an) { ap = an.error; if (!ap) { i = l(an.result) } }
                aq.callback(i, ap)
            }
            if (!aq.isPersistent) { delete y[ao] }
        }
    }
    ...
    function K() { if (C) { return C } var an = window[Rho.util.flag.API_AJAX_URL]; if (an) { return (C = an) } if (0 != window.location.protocol.indexOf("file")) { return (C = B) } var ao = ae.replace(/[\-<>A-Z_]*/g, ""); var i = Number(ao); if (0 < ao.length && !isNaN(i)) { return (C = (g.replace(/\/$/, "") + ":" + i + B)) } throw "Unknown API AJAX URL for application loaded with file:// protocol" }

    function X(ao, an, i) { af.ajax({ async: an, type: "post", url: K(), data: ao, dataType: "json", headers: { Accept: "text/plain" }, success: function(ap) { i(ap) }, error: function(ar, ap, aq) { i({ error: { message: aq, code: ar.status } }) } }) }

    function J(i) {
        if ("undefined" != typeof window.RhoOld) {
            if ("object" == typeof window.RhoOld) { for (var an in window.RhoOld) { if (window.RhoOld.hasOwnProperty(an) && "undefined" != typeof window.RhoOld[an] && "undefined" == typeof i[an]) { i[an] = window.RhoOld[an] } } }
            window.RhoOld = undefined
        }
        return i
    }
    var T = { flag: { API_AJAX_URL: "__rho_apiAjaxURL", USE_AJAX_BRIDGE: "__rho_useAjaxBridge", NATIVE_BRIDGE_TYPE: "__rho_nativeBridgeType" }, loadApiModules: I, namespace: aa, namespaceAlias: k, apiReqFor: ag, namesToProps: e, namesToArray: U, createPropsProxy: r, createRawPropsProxy: D, createMethodsProxy: aj, methodAccessReqFunc: d, incompatibleProps: u, rhoIdParam: function() { return W }, rhoClassParam: function() { return am }, nextId: b };
    var o = { id: { AJAX: "ajax", AUTO: "auto", RHOSIMULATOR: "rhosimulator", ANDROID: "android", IPHONE: "iphone", WP8: "wp8", WM: "wm", WIN32: "win32" }, nativeApiCall: X, nativeApiResult: function() {} };
    var V = J({ jQuery: af, util: T, platform: o, callbackHandler: q });
    ...
    f(o.id.ANDROID, function() {
        return {
            apiCall: function(ap, ao, an) {
                var i = {};
                if (window[S] && "function" == typeof window[S]["apiCall"]) { i = window[S].apiCall(ap, ao) } else { i = prompt(ap, ac + ":prompt") }
                an(JSON.parse(i))
            }
        }
    });
    f(o.id.IPHONE, function() {
        return window[S] || {
            apiCall: function(ap, an, i) {
                var ao = {};
                ao[ac] = ap;
                af.ajax({ async: an, type: "head", url: "/!" + S + "?" + (+new Date()), dataType: "json", headers: ao, success: function(at, aq, ar) { i(JSON.parse(ar.responseText)) }, error: function(at, aq, ar) { i({ error: { message: ar, code: at.status } }) } })
            }
        }
    });
    f(o.id.WP8, function() {
        var i = undefined;
        o.nativeApiResult = function(an) { i = an };
    ...
    f(o.id.RHOSIMULATOR, function() {
        return {
            apiCall: function(ap, ao, an) {
                var i = {};
                if (window[S] && "function" == typeof window[S]["apiCall"]) { i = window[S].apiCall(ap, ao) }
                an(JSON.parse(i))
            }
        }
    });
    ...
    f(o.id.AJAX, function() { return { apiCall: H } });
    var al = [
    ...
    var ad = null;
    for (var ah = 0; ah < al.length; ++ah) { if (al[ah][0].test(navigator.userAgent)) { ad = al[ah][1]; break } }
    if (!ad) {
        if (console && console.warn) { console.warn("User-Agent [" + navigator.userAgent + "] does not match any known platform. Falling back to use AJAX bridge by default.") }
        ad = A[o.id.AJAX]
    }
...
(function(f, c, d) {
    ...
    function e() {
        ...
        if (1 == arguments.length && arguments[0][d.rhoIdParam()]) {
            if (b != arguments[0][d.rhoClassParam()]) { throw "Wrong class instantiation!" }
            g = arguments[0][d.rhoIdParam()]
        } else { g = d.nextId() }
    }
    d.createPropsProxy(e.prototype, [], a, function() { return this.getId() });
    d.createMethodsProxy(e.prototype, [], a, function() { return this.getId() });
...
(function(f, c, d) {
    ...
    d.createMethodsProxy(e, [{ methodName: "send", nativeName: "send", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "startListening", nativeName: "startListening", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "stopListening", nativeName: "stopListening", valueCallbackIndex: 0 }], a);
    d.namespace(b, e)
})(Rho.jQuery, Rho, Rho.util);
(function(f, d, e) {
    var b = "Rho.Log";
    ...
    function c() {
        ...
        this.getId = function() { return g };
        if (1 == arguments.length && arguments[0][e.rhoIdParam()]) {
            if (b != arguments[0][e.rhoClassParam()]) { throw "Wrong class instantiation!" }
            g = arguments[0][e.rhoIdParam()]
        } else { g = e.nextId() }
    }
    e.createPropsProxy(c.prototype, [], a, function() { return this.getId() });
    e.createMethodsProxy(c.prototype, [], a, function() { return this.getId() });
    ...
    c.LEVEL_TRACE = 0;
    c.LEVEL_WARNING = 2;
    e.createPropsProxy(c, [{ propName: "level", propAccess: "rw" }, { propName: "destination", propAccess: "rw" }, { propName: "includeCategories", propAccess: "rw" }, { propName: "excludeCategories", propAccess: "rw" }, { propName: "fileSize", propAccess: "rw" }, { propName: "filePath", propAccess: "rw" }, { propName: "memoryPeriod", propAccess: "rw" }, { propName: "netTrace", propAccess: "rw" }, { propName: "skipPost", propAccess: "rw" }, { propName: "excludeFilter", propAccess: "rw" }, { propName: "destinationURI", propAccess: "rw" }], a);
    e.createMethodsProxy(c, [{ methodName: "trace", nativeName: "trace", valueCallbackIndex: 2 }, { methodName: "info", nativeName: "info", valueCallbackIndex: 2 }, { methodName: "warning", nativeName: "warning", valueCallbackIndex: 2 }, { methodName: "error", nativeName: "error", valueCallbackIndex: 2 }, { methodName: "fatalError", nativeName: "fatalError", valueCallbackIndex: 2 }, { methodName: "sendLogFile", nativeName: "sendLogFile", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "showLog", nativeName: "showLog", valueCallbackIndex: 0 }, { methodName: "cleanLogFile", nativeName: "cleanLogFile", valueCallbackIndex: 0 }, { methodName: "readLogFile", nativeName: "readLogFile", valueCallbackIndex: 1 }], a);
    e.namespace(b, c)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, d) {
    ...
    d.createMethodsProxy(e.prototype, [], a, function() { return this.getId() });
    d.createRawPropsProxy(e.prototype, []);
    d.createPropsProxy(e, [{ propName: "mainMenu", propAccess: "rw" }, { propName: "extraMenu", propAccess: "rw" }, { propName: "mainButton", propAccess: "rw" }, { propName: "extraButton", propAccess: "rw" }, { propName: "defaultMainMenu", propAccess: "r" }], a);
...
(function(f, c, d) {
    ...
    e.SYNC = "sync";
    d.createPropsProxy(e, [], a);
    d.createMethodsProxy(e, [{ methodName: "create", nativeName: "create", valueCallbackIndex: 2 }, { methodName: "remove", nativeName: "remove", valueCallbackIndex: 0 }, { methodName: "isCreated", nativeName: "isCreated", valueCallbackIndex: 0 }], a);
    d.namespace(b, e)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, e) {
    var b = "Rho.Navbar";
    ...
    e.createPropsProxy(d.prototype, [], a, function() { return this.getId() });
    e.createMethodsProxy(d.prototype, [], a, function() { return this.getId() });
    e.createRawPropsProxy(d.prototype, []);
    e.createPropsProxy(d, [], a);
    e.createMethodsProxy(d, [{ methodName: "create", nativeName: "create", valueCallbackIndex: 1 }, { methodName: "remove", nativeName: "remove", valueCallbackIndex: 0 }, { methodName: "started", nativeName: "started", valueCallbackIndex: 0 }], a);
    e.namespace(b, d)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, e) {
    var b = "Rho.Network";
...
(function(f, d, e) {
    ...
    e.createMethodsProxy(a, [{ methodName: "enumerate", nativeName: "enumerate", valueCallbackIndex: 0 }, { methodName: "getModel", nativeName: "getModel", valueCallbackIndex: 1 }, { methodName: "clear", nativeName: "clear", valueCallbackIndex: 0 }], b);
    e.namespace(c, a)
})(Rho.jQuery, Rho, Rho.util);
(function(e, c, d) {
...
(function(f, d, e) {
    ...
    e.createPropsProxy(a.prototype, [{ propName: "type", propAccess: "r" }, { propName: "userNotifyMode", propAccess: "rw" }, { propName: "pushServer", propAccess: "r" }, { propName: "pushAppName", propAccess: "r" }], b, function() { return this.getId() });
    e.createMethodsProxy(a.prototype, [{ methodName: "getDeviceId", nativeName: "getDeviceId", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "startNotifications", nativeName: "startNotifications", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "stopNotifications", nativeName: "stopNotifications", valueCallbackIndex: 0 }, { methodName: "getProperty", nativeName: "getProperty", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getProperties", nativeName: "getProperties", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getAllProperties", nativeName: "getAllProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "setProperty", nativeName: "setProperty", valueCallbackIndex: 2 }, { methodName: "setProperties", nativeName: "setProperties", valueCallbackIndex: 1 }], b, function() { return this.getId() });
    e.createRawPropsProxy(a.prototype, []);
    ...
    e.createPropsProxy(a, [], b);
    e.createMethodsProxy(a, [{ methodName: "enumerate", nativeName: "enumerate", persistentCallbackIndex: 0, valueCallbackIndex: 2 }], b);
    e.createPropsProxy(a, [{
        propName: "defaultInstance:getDefault:setDefault",
        propAccess: "rw",
        customSet: function(g) {
            if (!g || "function" != typeof g.getId) { throw "Default object should provide getId method!" }
            a.setDefaultID(g.getId())
        }
    }, { propName: "defaultID:getDefaultID:setDefaultID", propAccess: "rw" }], b);
    a.getId = function() { return a.getDefaultID() };
    e.createPropsProxy(a, [{ propName: "type", propAccess: "r" }, { propName: "userNotifyMode", propAccess: "rw" }, { propName: "pushServer", propAccess: "r" }, { propName: "pushAppName", propAccess: "r" }], b, function() { return this.getId() });
    e.createMethodsProxy(a, [{ methodName: "getDeviceId", nativeName: "getDeviceId", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "startNotifications", nativeName: "startNotifications", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "stopNotifications", nativeName: "stopNotifications", valueCallbackIndex: 0 }, { methodName: "getProperty", nativeName: "getProperty", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getProperties", nativeName: "getProperties", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getAllProperties", nativeName: "getAllProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "setProperty", nativeName: "setProperty", valueCallbackIndex: 2 }, { methodName: "setProperties", nativeName: "setProperties", valueCallbackIndex: 1 }], b, function() { return this.getId() });
...
(function(f, c, d) {
    ...
    d.createPropsProxy(e.prototype, [], a, function() { return this.getId() });
    d.createMethodsProxy(e.prototype, [{ methodName: "waitForApplication", nativeName: "waitForApplication", valueCallbackIndex: 0 }, { methodName: "closeHandle", nativeName: "closeHandle", valueCallbackIndex: 0 }, { methodName: "getProcessExitCode", nativeName: "getProcessExitCode", valueCallbackIndex: 0 }], a, function() { return this.getId() });
    d.createRawPropsProxy(e.prototype, []);
    d.createPropsProxy(e, [], a);
    d.createMethodsProxy(e, [{ methodName: "runApplication", nativeName: "runApplication", valueCallbackIndex: 3 }], a);
    d.namespace(b, e)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, d) {
    var b = "Rho.Timer";
    ...
    d.createPropsProxy(e.prototype, [], a, function() { return this.getId() });
    d.createMethodsProxy(e.prototype, [{ methodName: "start", nativeName: "start", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "stop", nativeName: "stop", valueCallbackIndex: 0 }, { methodName: "isAlive", nativeName: "isAlive", valueCallbackIndex: 0 }], a, function() { return this.getId() });
    d.createRawPropsProxy(e.prototype, []);
    d.createPropsProxy(e, [], a);
    d.createMethodsProxy(e, [{ methodName: "create", nativeName: "create", valueCallbackIndex: 0 }], a);
    d.namespace(b, e)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, d) {
    var b = "Rho.WebView";
...
(function(f, d, e) {
    ...
    a.getId = function() { return a.getDefaultID() };
    e.createPropsProxy(a, [{ propName: "autoEnter", propAccess: "rw" }, { propName: "autoTab", propAccess: "rw" }, { propName: "hapticFeedback", propAccess: "rw" }, { propName: "linearSecurityLevel", propAccess: "rw" }, { propName: "scanTimeout", propAccess: "rw" }, { propName: "rasterMode", propAccess: "rw" }, { propName: "rasterHeight", propAccess: "rw" }, { propName: "aimingPattern", propAccess: "rw" }, { propName: "aimType", propAccess: "rw" }, { propName: "timedAimDuration", propAccess: "rw" }, { propName: "sameSymbolTimeout", propAccess: "rw" }, { propName: "differentSymbolTimeout", propAccess: "rw" }, { propName: "digimarcDecoding", propAccess: "rw" }, { propName: "barcodeCount", propAccess: "rw" }, { propName: "instantReporting", propAccess: "rw" }, { propName: "aimMode", propAccess: "rw" }, { propName: "codeIdType", propAccess: "rw" }, { propName: "picklistMode", propAccess: "rw" }, { propName: "picklistEx", propAccess: "rw" }, { propName: "scanMode", propAccess: "rw" }, { propName: "sceneDetectionQualifier", propAccess: "rw" }, { propName: "characterSetSelection", propAccess: "rw" }, { propName: "autoCharacterSetFailureOption", propAccess: "rw" }, { propName: "enableGS1", propAccess: "rw" }, { propName: "enableHIBCC", propAccess: "rw" }, { propName: "enableICCBBA", propAccess: "rw" }, { propName: "viewfinderMode", propAccess: "rw" }, { propName: "viewfinderX", propAccess: "rw" }, { propName: "viewfinderY", propAccess: "rw" }, { propName: "viewfinderWidth", propAccess: "rw" }, { propName: "viewfinderHeight", propAccess: "rw" }, { propName: "viewfinderFeedback", propAccess: "rw" }, { propName: "viewfinderFeedbackTime", propAccess: "rw" }, { propName: "focusMode", propAccess: "rw" }, { propName: "illuminationBrightness", propAccess: "rw" }, { propName: "illuminationMode", propAccess: "rw" }, { propName: "dpmMode", propAccess: "rw" }, { propName: "inverse1dMode", propAccess: "rw" }, { propName: "poorQuality1dMode", propAccess: "rw" }, { propName: "beamWidth", propAccess: "rw" }, { propName: "dbpMode", propAccess: "rw" }, { propName: "klasseEins", propAccess: "rw" }, { propName: "adaptiveScanning", propAccess: "rw" }, { propName: "bidirectionalRedundancy", propAccess: "rw" }, { propName: "barcodeDataFormat", propAccess: "rw" }, { propName: "dataBufferSize", propAccess: "rw" }, { propName: "connectionIdleTimeout", propAccess: "rw" }, { propName: "disconnectBtOnDisable", propAccess: "rw" }, { propName: "displayBtAddressBarcodeOnEnable", propAccess: "rw" }, { propName: "enableTimeout", propAccess: "rw" }, { propName: "friendlyName", propAccess: "r" }, { propName: "lcdMode", propAccess: "rw" }, { propName: "lowBatteryScan", propAccess: "rw" }, { propName: "triggerConnected", propAccess: "rw" }, { propName: "disableScannerDuringNavigate", propAccess: "rw" }, { propName: "decodeVolume", propAccess: "rw" }, { propName: "decodeDuration", propAccess: "rw" }, { propName: "decodeFrequency", propAccess: "rw" }, { propName: "invalidDecodeFrequency", propAccess: "rw" }, { propName: "decodeSound", propAccess: "rw" }, { propName: "invalidDecodeSound", propAccess: "rw" }, { propName: "scannerType", propAccess: "r" }, { propName: "allDecoders", propAccess: "rw" }, { propName: "aztec", propAccess: "rw" }, { propName: "chinese2of5", propAccess: "rw" }, { propName: "codabar", propAccess: "rw" }, { propName: "codabarClsiEditing", propAccess: "rw" }, { propName: "codabarMaxLength", propAccess: "rw" }, { propName: "codabarMinLength", propAccess: "rw" }, { propName: "codabarNotisEditing", propAccess: "rw" }, { propName: "codabarRedundancy", propAccess: "rw" }, { propName: "code11", propAccess: "rw" }, { propName: "code11checkDigitCount", propAccess: "rw" }, { propName: "code11maxLength", propAccess: "rw" }, { propName: "code11minLength", propAccess: "rw" }, { propName: "code11redundancy", propAccess: "rw" }, { propName: "code11reportCheckDigit", propAccess: "rw" }, { propName: "code128", propAccess: "rw" }, { propName: "code128checkIsBtTable", propAccess: "rw" }, { propName: "code128ean128", propAccess: "rw" }, { propName: "code128isbt128", propAccess: "rw" }, { propName: "code128isbt128ConcatMode", propAccess: "rw" }, { propName: "code128maxLength", propAccess: "rw" }, { propName: "code128minLength", propAccess: "rw" }, { propName: "code128other128", propAccess: "rw" }, { propName: "code128redundancy", propAccess: "rw" }, { propName: "code128securityLevel", propAccess: "rw" }, { propName: "compositeAb", propAccess: "rw" }, { propName: "compositeAbUccLinkMode", propAccess: "rw" }, { propName: "compositeAbUseUpcPreambleCheckDigitRules", propAccess: "rw" }, { propName: "compositeC", propAccess: "rw" }, { propName: "code39", propAccess: "rw" }, { propName: "code39code32Prefix", propAccess: "rw" }, { propName: "code39convertToCode32", propAccess: "rw" }, { propName: "code39fullAscii", propAccess: "rw" }, { propName: "code39maxLength", propAccess: "rw" }, { propName: "code39minLength", propAccess: "rw" }, { propName: "code39redundancy", propAccess: "rw" }, { propName: "code39reportCheckDigit", propAccess: "rw" }, { propName: "code39securityLevel", propAccess: "rw" }, { propName: "code39verifyCheckDigit", propAccess: "rw" }, { propName: "code93", propAccess: "rw" }, { propName: "code93maxLength", propAccess: "rw" }, { propName: "code93minLength", propAccess: "rw" }, { propName: "code93redundancy", propAccess: "rw" }, { propName: "d2of5", propAccess: "rw" }, { propName: "d2of5maxLength", propAccess: "rw" }, { propName: "d2of5minLength", propAccess: "rw" }, { propName: "d2of5redundancy", propAccess: "rw" }, { propName: "datamatrix", propAccess: "rw" }, { propName: "dotCode", propAccess: "rw" }, { propName: "dotCodeInverse", propAccess: "rw" }, { propName: "dotCodeMirror", propAccess: "rw" }, { propName: "gridMatrix", propAccess: "rw" }, { propName: "gridMatrixInverse", propAccess: "rw" }, { propName: "gridMatrixMirror", propAccess: "rw" }, { propName: "ean13", propAccess: "rw" }, { propName: "ean8", propAccess: "rw" }, { propName: "ean8convertToEan13", propAccess: "rw" }, { propName: "hanXin", propAccess: "rw" }, { propName: "hanXinInverse", propAccess: "rw" }, { propName: "i2of5", propAccess: "rw" }, { propName: "i2of5convertToEan13", propAccess: "rw" }, { propName: "i2of5reducedQuietZone", propAccess: "rw" }, { propName: "i2of5febraban", propAccess: "rw" }, { propName: "i2of5maxLength", propAccess: "rw" }, { propName: "i2of5minLength", propAccess: "rw" }, { propName: "i2of5redundancy", propAccess: "rw" }, { propName: "i2of5reportCheckDigit", propAccess: "rw" }, { propName: "i2of5verifyCheckDigit", propAccess: "rw" }, { propName: "korean3of5", propAccess: "rw" }, { propName: "korean3of5redundancy", propAccess: "rw" }, { propName: "korean3of5maxLength", propAccess: "rw" }, { propName: "korean3of5minLength", propAccess: "rw" }, { propName: "macroPdf", propAccess: "rw" }, { propName: "macroPdfBufferLabels", propAccess: "rw" }, { propName: "macroPdfConvertToPdf417", propAccess: "rw" }, { propName: "macroPdfExclusive", propAccess: "rw" }, { propName: "macroMicroPdf", propAccess: "rw" }, { propName: "macroMicroPdfBufferLabels", propAccess: "rw" }, { propName: "macroMicroPdfConvertToMicroPdf", propAccess: "rw" }, { propName: "macroMicroPdfExclusive", propAccess: "rw" }, { propName: "macroMicroPdfReportAppendInfo", propAccess: "rw" }, { propName: "mailMark", propAccess: "rw" }, { propName: "matrix2of5", propAccess: "rw" }, { propName: "matrix2of5maxLength", propAccess: "rw" }, { propName: "matrix2of5minLength", propAccess: "rw" }, { propName: "matrix2of5reportCheckDigit", propAccess: "rw" }, { propName: "matrix2of5verifyCheckDigit", propAccess: "rw" }, { propName: "maxiCode", propAccess: "rw" }, { propName: "microPdf", propAccess: "rw" }, { propName: "microQr", propAccess: "rw" }, { propName: "msi", propAccess: "rw" }, { propName: "msiCheckDigits", propAccess: "rw" }, { propName: "msiCheckDigitScheme", propAccess: "rw" }, { propName: "msiMaxLength", propAccess: "rw" }, { propName: "msiMinLength", propAccess: "rw" }, { propName: "msiRedundancy", propAccess: "rw" }, { propName: "msiReportCheckDigit", propAccess: "rw" }, { propName: "pdf417", propAccess: "rw" }, { propName: "signature", propAccess: "rw" }, { propName: "signatureImageHeight", propAccess: "rw" }, { propName: "signatureImageWidth", propAccess: "rw" }, { propName: "signatureImageQuality", propAccess: "rw" }, { propName: "ausPostal", propAccess: "rw" }, { propName: "canPostal", propAccess: "rw" }, { propName: "dutchPostal", propAccess: "rw" }, { propName: "japPostal", propAccess: "rw" }, { propName: "ukPostal", propAccess: "rw" }, { propName: "ukPostalReportCheckDigit", propAccess: "rw" }, { propName: "us4state", propAccess: "rw" }, { propName: "us4stateFics", propAccess: "rw" }, { propName: "usPlanet", propAccess: "rw" }, { propName: "usPlanetReportCheckDigit", propAccess: "rw" }, { propName: "usPostNet", propAccess: "rw" }, { propName: "usPostNetReportCheckDigit", propAccess: "rw" }, { propName: "qrCode", propAccess: "rw" }, { propName: "gs1dataBar", propAccess: "rw" }, { propName: "gs1dataBarExpanded", propAccess: "rw" }, { propName: "gs1dataBarLimited", propAccess: "rw" }, { propName: "gs1LimitedSecurityLevel", propAccess: "rw" }, { propName: "gs1QrCode", propAccess: "rw" }, { propName: "gs1Datamatrix", propAccess: "rw" }, { propName: "tlc39", propAccess: "rw" }, { propName: "trioptic39", propAccess: "rw" }, { propName: "trioptic39Redundancy", propAccess: "rw" }, { propName: "upcEanBookland", propAccess: "rw" }, { propName: "upcEanBooklandFormat", propAccess: "rw" }, { propName: "upcEanConvertGs1dataBarToUpcEan", propAccess: "rw" }, { propName: "upcEanCoupon", propAccess: "rw" }, { propName: "upcEanCouponReport", propAccess: "rw" }, { propName: "upcEanLinearDecode", propAccess: "rw" }, { propName: "upcEanRandomWeightCheckDigit", propAccess: "rw" }, { propName: "upcEanRetryCount", propAccess: "rw" }, { propName: "upcEanSecurityLevel", propAccess: "rw" }, { propName: "upcEanSupplemental2", propAccess: "rw" }, { propName: "upcEanSupplemental5", propAccess: "rw" }, { propName: "upcEanSupplementalMode", propAccess: "rw" }, { propName: "upca", propAccess: "rw" }, { propName: "upcaPreamble", propAccess: "rw" }, { propName: "upcaReportCheckDigit", propAccess: "rw" }, { propName: "upce0", propAccess: "rw" }, { propName: "upce0convertToUpca", propAccess: "rw" }, { propName: "upce0preamble", propAccess: "rw" }, { propName: "upce0reportCheckDigit", propAccess: "rw" }, { propName: "upce1", propAccess: "rw" }, { propName: "upce1convertToUpca", propAccess: "rw" }, { propName: "upce1preamble", propAccess: "rw" }, { propName: "upce1reportCheckDigit", propAccess: "rw" }, { propName: "webcode", propAccess: "rw" }, { propName: "webcodeDecodeGtSubtype", propAccess: "rw" }, { propName: "rsmModelNumber", propAccess: "r" }, { propName: "rsmSerialNumber", propAccess: "r" }, { propName: "rsmDateOfManufacture", propAccess: "r" }, { propName: "rsmDateOfService", propAccess: "r" }, { propName: "rsmBluetoothAddress", propAccess: "r" }, { propName: "rsmFirmwareVersion", propAccess: "r" }, { propName: "rsmDeviceClass", propAccess: "r" }, { propName: "rsmBatteryStatus", propAccess: "r" }, { propName: "rsmBatteryCapacity", propAccess: "r" }, { propName: "rsmBatteryId", propAccess: "r" }, { propName: "rsmBluetoothAuthentication", propAccess: "rw" }, { propName: "rsmBluetoothEncryption", propAccess: "rw" }, { propName: "rsmBluetoothPinCode", propAccess: "rw" }, { propName: "rsmBluetoothPinCodeType", propAccess: "rw" }, { propName: "rsmBluetoothReconnectionAttempts", propAccess: "rw" }, { propName: "rsmBluetoothBeepOnReconnectAttempt", propAccess: "rw" }, { propName: "rsmBluetoothHidAutoReconnect", propAccess: "rw" }, { propName: "rsmBluetoothFriendlyName", propAccess: "rw" }, { propName: "rsmBluetoothInquiryMode", propAccess: "rw" }, { propName: "rsmBluetoothAutoReconnect", propAccess: "rw" }, { propName: "rsmForceSavePairingBarcode", propAccess: "rw" }, { propName: "rsmLowBatteryIndication", propAccess: "rw" }, { propName: "rsmLowBatteryIndicationCycle", propAccess: "rw" }, { propName: "rsmScanLineWidth", propAccess: "rw" }, { propName: "rsmGoodScansDelay", propAccess: "rw" }, { propName: "rsmDecodeFeedback", propAccess: "rw" }, { propName: "rsmIgnoreCode128Usps", propAccess: "rw" }, { propName: "rsmScanTriggerWakeup", propAccess: "rw" }, { propName: "rsmMems", propAccess: "rw" }, { propName: "rsmProximityEnable", propAccess: "rw" }, { propName: "rsmProximityContinuous", propAccess: "rw" }, { propName: "rsmProximityDistance", propAccess: "rw" }, { propName: "rsmPagingEnable", propAccess: "rw" }, { propName: "rsmPagingBeepSequence", propAccess: "rw" }, { propName: "pairAfterScannerReboot", propAccess: "rw" }, { propName: "disconnectOnExit", propAccess: "rw" }, { propName: "connectionIdleTime", propAccess: "rw" }, { propName: "decodeLEDFeedback", propAccess: "rw" }, { propName: "decodeLEDTime", propAccess: "rw" }, { propName: "decodeLEDFeedbackMode", propAccess: "rw" }, { propName: "decodeScreenNotification", propAccess: "rw" }, { propName: "decodeScreenNotificationTime ", propAccess: "rw" }, { propName: "decodeScreenTranslucencyLevel", propAccess: "rw" }, { propName: "oneDQuietZoneLevel", propAccess: "rw" }, { propName: "poorQualityDecodeEffortLevel", propAccess: "rw" }, { propName: "zoom", propAccess: "rw" }, { propName: "triggerType", propAccess: "rw" }], b, function() { return this.getId() });
    e.createMethodsProxy(a, [{ methodName: "enable", nativeName: "enable", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "setautoCharacterSetPreference", nativeName: "setautoCharacterSetPreference", valueCallbackIndex: 1 }, { methodName: "getautoCharacterSetPreference", nativeName: "getautoCharacterSetPreference", valueCallbackIndex: 0 }, { methodName: "registerBluetoothStatus", nativeName: "registerBluetoothStatus", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "addConnectionListener", nativeName: "addConnectionListener", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "removeConnectionListener", nativeName: "removeConnectionListener", valueCallbackIndex: 0 }, { methodName: "start", nativeName: "start", valueCallbackIndex: 0 }, { methodName: "stop", nativeName: "stop", valueCallbackIndex: 0 }, { methodName: "disable", nativeName: "disable", valueCallbackIndex: 0 }, { methodName: "resetToDefault", nativeName: "resetToDefault", valueCallbackIndex: 0 }, { methodName: "isParamSupported", nativeName: "isParamSupported", valueCallbackIndex: 1 }, { methodName: "getSupportedProperties", nativeName: "getSupportedProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "take", nativeName: "take", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "commandRemoteScanner", nativeName: "commandRemoteScanner", valueCallbackIndex: 1 }, { methodName: "getProperty", nativeName: "getProperty", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getProperties", nativeName: "getProperties", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getAllProperties", nativeName: "getAllProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "setProperty", nativeName: "setProperty", valueCallbackIndex: 2 }, { methodName: "setProperties", nativeName: "setProperties", valueCallbackIndex: 1 }], b, function() { return this.getId() });
    e.createRawPropsProxy(a, []);
    e.namespace(c, a)
})(Rho.jQuery, Rho, Rho.util);
(function(f, d, e) {
...
(function(f, d, e) {
    ...
    e.createRawPropsProxy(c.prototype, []);
    e.createPropsProxy(c, [], a);
    e.createMethodsProxy(c, [{ methodName: "writeToConfig", nativeName: "writeToConfig", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "writeToTempConfig", nativeName: "writeToTempConfig", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "readFromTempConfig", nativeName: "readFromTempConfig", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "readFromOriginalConfig", nativeName: "readFromOriginalConfig", persistentCallbackIndex: 0, valueCallbackIndex: 2 }], a);
    e.namespace(b, c)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, e) {
    var b = "Rho.Printer";
    ...
    }, { propName: "defaultID:getDefaultID:setDefaultID", propAccess: "rw" }], a);
    d.getId = function() { return d.getDefaultID() };
    e.createPropsProxy(d, [{ propName: "ID", propAccess: "r" }, { propName: "deviceName", propAccess: "r" }, { propName: "printerType", propAccess: "r" }, { propName: "deviceAddress", propAccess: "r" }, { propName: "devicePort", propAccess: "rw" }, { propName: "connectionType", propAccess: "r" }, { propName: "isConnected", propAccess: "r" }], a, function() { return this.getId() });
    e.createMethodsProxy(d, [{ methodName: "connect", nativeName: "connect", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "connectWithOptions", nativeName: "connectWithOptions", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "requestState", nativeName: "requestState", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "disconnect", nativeName: "disconnect", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "printFile", nativeName: "printFile", persistentCallbackIndex: 2, valueCallbackIndex: 4 }, { methodName: "printImageFromFile", nativeName: "printImageFromFile", persistentCallbackIndex: 4, valueCallbackIndex: 6 }, { methodName: "printRawString", nativeName: "printRawString", persistentCallbackIndex: 2, valueCallbackIndex: 4 }, { methodName: "enumerateSupportedControlLanguages", nativeName: "enumerateSupportedControlLanguages", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "getProperty", nativeName: "getProperty", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getProperties", nativeName: "getProperties", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getAllProperties", nativeName: "getAllProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "setProperty", nativeName: "setProperty", valueCallbackIndex: 2 }, { methodName: "setProperties", nativeName: "setProperties", valueCallbackIndex: 1 }], a, function() { return this.getId() });
...
(function(e, c, d) {
    ...
    d.createPropsProxy(f.prototype, [{ propName: "ID", propAccess: "r" }, { propName: "deviceName", propAccess: "r" }, { propName: "printerType", propAccess: "r" }, { propName: "deviceAddress", propAccess: "r" }, { propName: "devicePort", propAccess: "rw" }, { propName: "connectionType", propAccess: "r" }, { propName: "isConnected", propAccess: "r" }], a, function() { return this.getId() });
    ...
    f.getId = function() { return f.getDefaultID() };
    d.createPropsProxy(f, [{ propName: "ID", propAccess: "r" }, { propName: "deviceName", propAccess: "r" }, { propName: "printerType", propAccess: "r" }, { propName: "deviceAddress", propAccess: "r" }, { propName: "devicePort", propAccess: "rw" }, { propName: "connectionType", propAccess: "r" }, { propName: "isConnected", propAccess: "r" }], a, function() { return this.getId() });
...
(function(f, c, d) {
    ...
    d.createPropsProxy(e.prototype, [{ propName: "minimumGap", propAccess: "rw" }, { propName: "type", propAccess: "r" }, { propName: "status", propAccess: "r" }], a, function() { return this.getId() });
    d.createMethodsProxy(e.prototype, [{ methodName: "start", nativeName: "start", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "readData", nativeName: "readData", valueCallbackIndex: 0 }, { methodName: "stop", nativeName: "stop", valueCallbackIndex: 0 }, { methodName: "getProperty", nativeName: "getProperty", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getProperties", nativeName: "getProperties", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getAllProperties", nativeName: "getAllProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "setProperty", nativeName: "setProperty", valueCallbackIndex: 2 }, { methodName: "setProperties", nativeName: "setProperties", valueCallbackIndex: 1 }], a, function() { return this.getId() });
    d.createRawPropsProxy(e.prototype, []);
    ...
    d.createPropsProxy(e, [{ propName: "proximitySensorType", propAccess: "rw" }], a);
    d.createMethodsProxy(e, [{ methodName: "makeSensorByType", nativeName: "makeSensorByType", valueCallbackIndex: 1 }, { methodName: "enumerate", nativeName: "enumerate", persistentCallbackIndex: 0, valueCallbackIndex: 2 }], a);
    d.namespace(b, e)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, d) {
    ...
    d.createPropsProxy(e.prototype, [{ propName: "pinTimeout", propAccess: "rw" }, { propName: "pinEntry", propAccess: "rw" }, { propName: "panData", propAccess: "rw" }, { propName: "autoTab", propAccess: "rw" }, { propName: "autoEnter", propAccess: "rw" }, { propName: "moduleName", propAccess: "rw" }], a, function() { return this.getId() });
    d.createMethodsProxy(e.prototype, [{ methodName: "open", nativeName: "open", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "close", nativeName: "close", valueCallbackIndex: 0 }, { methodName: "getProperty", nativeName: "getProperty", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getProperties", nativeName: "getProperties", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getAllProperties", nativeName: "getAllProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "setProperty", nativeName: "setProperty", valueCallbackIndex: 2 }, { methodName: "setProperties", nativeName: "setProperties", valueCallbackIndex: 1 }], a, function() { return this.getId() });
    d.createRawPropsProxy(e.prototype, []);
    e.DCR7000 = "dcr7000";
    e.MSR3000 = "msr3000";
    e.MSR55 = "msr55";
    ...
    e.MSRCAMEO = "msrcameo";
    d.createPropsProxy(e, [], a);
    d.createMethodsProxy(e, [{ methodName: "enumerate", nativeName: "enumerate", persistentCallbackIndex: 0, valueCallbackIndex: 2 }], a);
    ...
    e.getId = function() { return e.getDefaultID() };
    d.createPropsProxy(e, [{ propName: "pinTimeout", propAccess: "rw" }, { propName: "pinEntry", propAccess: "rw" }, { propName: "panData", propAccess: "rw" }, { propName: "autoTab", propAccess: "rw" }, { propName: "autoEnter", propAccess: "rw" }, { propName: "moduleName", propAccess: "rw" }], a, function() { return this.getId() });
    d.createMethodsProxy(e, [{ methodName: "open", nativeName: "open", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "close", nativeName: "close", valueCallbackIndex: 0 }, { methodName: "getProperty", nativeName: "getProperty", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getProperties", nativeName: "getProperties", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getAllProperties", nativeName: "getAllProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "setProperty", nativeName: "setProperty", valueCallbackIndex: 2 }, { methodName: "setProperties", nativeName: "setProperties", valueCallbackIndex: 1 }], a, function() { return this.getId() });
...
(function(e, c, d) {
    ...
    d.createPropsProxy(f.prototype, [{ propName: "source", propAccess: "rw" }, { propName: "encoder", propAccess: "rw" }, { propName: "maxDuration", propAccess: "rw" }, { propName: "fileName", propAccess: "rw" }], a, function() { return this.getId() });
    ...
    f.getId = function() { return f.getDefaultID() };
    d.createPropsProxy(f, [{ propName: "source", propAccess: "rw" }, { propName: "encoder", propAccess: "rw" }, { propName: "maxDuration", propAccess: "rw" }, { propName: "fileName", propAccess: "rw" }], a, function() { return this.getId() });
...
(function(f, d, e) {
    ...
    e.createMethodsProxy(c.prototype, [], a, function() { return this.getId() });
    e.createRawPropsProxy(c.prototype, []);
    e.createPropsProxy(c, [{ propName: "excludeCategories", propAccess: "rw" }, { propName: "maxLines", propAccess: "rw" }], a);
    e.createMethodsProxy(c, [{ methodName: "start", nativeName: "start", valueCallbackIndex: 0 }, { methodName: "stop", nativeName: "stop", valueCallbackIndex: 0 }, { methodName: "clear", nativeName: "clear", valueCallbackIndex: 0 }, { methodName: "numLines", nativeName: "numLines", valueCallbackIndex: 0 }, { methodName: "read", nativeName: "read", valueCallbackIndex: 0 }], a);
    e.namespace(b, c)
})(Rho.jQuery, Rho, Rho.util);
(function(f, d, e) {
    ...
    e.createRawPropsProxy(c.prototype, []);
    e.createPropsProxy(c, [], a);
    e.createMethodsProxy(c, [{ methodName: "enumerate", nativeName: "enumerate", persistentCallbackIndex: 0, valueCallbackIndex: 2 }], a);
    ...
    c.getId = function() { return c.getDefaultID() };
    e.createPropsProxy(c, [], a, function() { return this.getId() });
    e.createMethodsProxy(c, [{ methodName: "simulate_key_event_code", nativeName: "simulate_key_event_code", valueCallbackIndex: 1 }, { methodName: "simulate_key_event_string", nativeName: "simulate_key_event_string", valueCallbackIndex: 1 }, { methodName: "simulate_touch_event", nativeName: "simulate_touch_event", valueCallbackIndex: 3 }, { methodName: "screen_capture", nativeName: "screen_capture", valueCallbackIndex: 1 }, { methodName: "get_allocated_memory", nativeName: "get_allocated_memory", valueCallbackIndex: 0 }, { methodName: "delete_file", nativeName: "delete_file", valueCallbackIndex: 1 }, { methodName: "file_exists", nativeName: "file_exists", valueCallbackIndex: 1 }, { methodName: "re_simulate_navigation", nativeName: "re_simulate_navigation", valueCallbackIndex: 0 }, { methodName: "getProperty", nativeName: "getProperty", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getProperties", nativeName: "getProperties", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getAllProperties", nativeName: "getAllProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "setProperty", nativeName: "setProperty", valueCallbackIndex: 2 }, { methodName: "setProperties", nativeName: "setProperties", valueCallbackIndex: 1 }], a, function() { return this.getId() });
...
(function(f, c, d) {
    ...
    d.createMethodsProxy(e.prototype, [], a, function() { return this.getId() });
    d.createRawPropsProxy(e.prototype, []);
    d.createPropsProxy(e, [{ propName: "hostURL", propAccess: "r" }, { propName: "trackConnection", propAccess: "r" }, { propName: "timeout", propAccess: "r" }, { propName: "pollInterval", propAccess: "r" }, { propName: "message", propAccess: "r" }], a);
    d.createMethodsProxy(e, [], a);
    d.namespace(b, e)
})(Rho.jQuery, Rho, Rho.util);
(function(e, c, d) {
    ...
    d.createPropsProxy(f, [{ propName: "chargeState", propAccess: "rw" }, { propName: "rowId", propAccess: "rw" }, { propName: "columnId", propAccess: "rw" }, { propName: "wallId", propAccess: "rw" }, { propName: "hardwareId", propAccess: "r" }, { propName: "partNumber", propAccess: "r" }, { propName: "serialNumber", propAccess: "r" }, { propName: "mfgDate", propAccess: "r" }, { propName: "driverVersion", propAccess: "r" }, { propName: "cApiVersion", propAccess: "r" }, { propName: "firmwareVersion", propAccess: "r" }], a);
...
(function(f, d, e) {
    ...
    e.createPropsProxy(c, [], a);
    e.createMethodsProxy(c, [{ methodName: "enumerate", nativeName: "enumerate", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "getCameraByType", nativeName: "getCameraByType", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "choosePicture", nativeName: "choosePicture", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "copyImageToDeviceGallery", nativeName: "copyImageToDeviceGallery", valueCallbackIndex: 1 }], a);
    e.createPropsProxy(c, [{
        propName: "defaultInstance:getDefault:setDefault",
        propAccess: "rw",
        customSet: function(g) {
    ...
    c.getId = function() { return c.getDefaultID() };
    e.createPropsProxy(c, [{ propName: "cameraType", propAccess: "r" }, { propName: "maxWidth", propAccess: "r" }, { propName: "maxHeight", propAccess: "r" }, { propName: "supportedSizeList", propAccess: "r" }, { propName: "desiredWidth", propAccess: "rw" }, { propName: "desiredHeight", propAccess: "rw" }, { propName: "fileName", propAccess: "rw" }, { propName: "compressionFormat", propAccess: "rw" }, { propName: "outputFormat", propAccess: "rw" }, { propName: "colorModel", propAccess: "rw" }, { propName: "enableEditing", propAccess: "rw" }, { propName: "flashMode", propAccess: "rw" }, { propName: "saveToDeviceGallery", propAccess: "rw" }, { propName: "captureSound", propAccess: "rw" }, { propName: "previewLeft", propAccess: "rw" }, { propName: "previewTop", propAccess: "rw" }, { propName: "previewWidth", propAccess: "rw" }, { propName: "previewHeight", propAccess: "rw" }, { propName: "useSystemViewfinder", propAccess: "rw" }, { propName: "aimMode", propAccess: "rw" }], a, function() { return this.getId() });
    e.createMethodsProxy(c, [{ methodName: "takePicture", nativeName: "takePicture", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "showPreview", nativeName: "showPreview", valueCallbackIndex: 1 }, { methodName: "hidePreview", nativeName: "hidePreview", valueCallbackIndex: 0 }, { methodName: "capture", nativeName: "capture", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "getProperty", nativeName: "getProperty", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getProperties", nativeName: "getProperties", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getAllProperties", nativeName: "getAllProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "setProperty", nativeName: "setProperty", valueCallbackIndex: 2 }, { methodName: "setProperties", nativeName: "setProperties", valueCallbackIndex: 1 }], a, function() { return this.getId() });
    e.createRawPropsProxy(c, []);
    e.namespace(b, c)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, d) {
    ...
    d.createPropsProxy(e.prototype, [{ propName: "duration", propAccess: "rw" }, { propName: "fileName", propAccess: "rw" }, { propName: "saveToGallery", propAccess: "rw" }, { propName: "resolution", propAccess: "rw" }], a, function() { return this.getId() });
    d.createMethodsProxy(e.prototype, [{ methodName: "start", nativeName: "start", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "stop", nativeName: "stop", valueCallbackIndex: 0 }, { methodName: "cancel", nativeName: "cancel", valueCallbackIndex: 0 }, { methodName: "getProperty", nativeName: "getProperty", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getProperties", nativeName: "getProperties", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getAllProperties", nativeName: "getAllProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "setProperty", nativeName: "setProperty", valueCallbackIndex: 2 }, { methodName: "setProperties", nativeName: "setProperties", valueCallbackIndex: 1 }], a, function() { return this.getId() });
    d.createRawPropsProxy(e.prototype, []);
    e.HIGH = "high";
    e.LOW = "low";
    d.createPropsProxy(e, [], a);
    ...
    e.getId = function() { return e.getDefaultID() };
    d.createPropsProxy(e, [{ propName: "duration", propAccess: "rw" }, { propName: "fileName", propAccess: "rw" }, { propName: "saveToGallery", propAccess: "rw" }, { propName: "resolution", propAccess: "rw" }], a, function() { return this.getId() });
    d.createMethodsProxy(e, [{ methodName: "start", nativeName: "start", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "stop", nativeName: "stop", valueCallbackIndex: 0 }, { methodName: "cancel", nativeName: "cancel", valueCallbackIndex: 0 }, { methodName: "getProperty", nativeName: "getProperty", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getProperties", nativeName: "getProperties", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "getAllProperties", nativeName: "getAllProperties", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "setProperty", nativeName: "setProperty", valueCallbackIndex: 2 }, { methodName: "setProperties", nativeName: "setProperties", valueCallbackIndex: 1 }], a, function() { return this.getId() });
    d.createRawPropsProxy(e, []);
    d.namespace(b, e)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, d) {
    ...
    d.createRawPropsProxy(e.prototype, []);
    d.createPropsProxy(e, [], a);
    d.createMethodsProxy(e, [{ methodName: "createShorcut", nativeName: "createShorcut", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "XMLParseForShortCutCreation", nativeName: "XMLParseForShortCutCreation", persistentCallbackIndex: 0, valueCallbackIndex: 2 }], a);
    d.namespace(b, e)
})(Rho.jQuery, Rho, Rho.util);
(function(f, d, e) {
    var c = "Rho.Mx";
...
(function(f, c, d) {
    ...
    d.createRawPropsProxy(e.prototype, []);
    d.createPropsProxy(e, [], a);
    d.createMethodsProxy(e, [{ methodName: "show", nativeName: "show", valueCallbackIndex: 0 }, { methodName: "hide", nativeName: "hide", valueCallbackIndex: 0 }, { methodName: "disableAllIME", nativeName: "disableAllIME", valueCallbackIndex: 0 }, { methodName: "resetToDefault", nativeName: "resetToDefault", valueCallbackIndex: 0 }], a);
    d.namespace(b, e)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, d) {
    var b = "Rho.EzNFC";
    ...
    d.createMethodsProxy(e.prototype, [], a, function() { return this.getId() });
    d.createRawPropsProxy(e.prototype, []);
    d.createPropsProxy(e, [{ propName: "isSupported", propAccess: "rw" }, { propName: "isEnabled", propAccess: "rw" }], a);
    d.createMethodsProxy(e, [{ methodName: "enableAdapter", nativeName: "enableAdapter", valueCallbackIndex: 0 }, { methodName: "enableRead", nativeName: "enableRead", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "disableRead", nativeName: "disableRead", valueCallbackIndex: 0 }], a);
    d.namespace(b, e)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, d) {
    ...
    d.createMethodsProxy(e, [{ methodName: "enable", nativeName: "enable", valueCallbackIndex: 0 }, { methodName: "clearproperties", nativeName: "clearproperties", valueCallbackIndex: 0 }, { methodName: "disable", nativeName: "disable", valueCallbackIndex: 0 }, { methodName: "cancelNotification", nativeName: "cancelNotification", valueCallbackIndex: 0 }, { methodName: "notify", nativeName: "notify", valueCallbackIndex: 1 }], a, function() { return this.getId() });
    d.createRawPropsProxy(e, []);
    d.namespace(b, e)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, e) {
    ...
    e.createRawPropsProxy(d.prototype, []);
    e.createPropsProxy(d, [], a);
    e.createMethodsProxy(d, [{ methodName: "connect", nativeName: "connect", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "disconnect", nativeName: "disconnect", valueCallbackIndex: 0 }, { methodName: "disable", nativeName: "disable", valueCallbackIndex: 0 }, { methodName: "enable", nativeName: "enable", valueCallbackIndex: 0 }, { methodName: "setLayout", nativeName: "setLayout", valueCallbackIndex: 2 }, { methodName: "clearLayout", nativeName: "clearLayout", valueCallbackIndex: 0 }], a);
    e.createPropsProxy(d, [{
        propName: "defaultInstance:getDefault:setDefault",
        propAccess: "rw",
        customSet: function(g) {
    ...
    d.getId = function() { return d.getDefaultID() };
    e.createPropsProxy(d, [], a, function() { return this.getId() });
    e.createMethodsProxy(d, [], a, function() { return this.getId() });
    e.createRawPropsProxy(d, []);
    e.namespace(b, d)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, e) {
    ...
    e.createRawPropsProxy(d.prototype, []);
    e.createPropsProxy(d, [], a);
    e.createMethodsProxy(d, [{ methodName: "readData", nativeName: "readData", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "writeData", nativeName: "writeData", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "connect", nativeName: "connect", persistentCallbackIndex: 2, valueCallbackIndex: 4 }, { methodName: "disconnect", nativeName: "disconnect", persistentCallbackIndex: 0, valueCallbackIndex: 2 }], a);
    e.namespace(b, d)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, e) {
    ...
    e.createPropsProxy(d.prototype, [{ propName: "baudRates", propAccess: "rw" }, { propName: "dataBit", propAccess: "rw" }, { propName: "flowControlMode", propAccess: "rw" }, { propName: "ParityBit", propAccess: "rw" }, { propName: "stopBit", propAccess: "rw" }, { propName: "friendlyName", propAccess: "r" }], a, function() { return this.getId() });
    e.createMethodsProxy(d.prototype, [{ methodName: "enable", nativeName: "enable", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "disable", nativeName: "disable", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "read", nativeName: "read", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "write", nativeName: "write", persistentCallbackIndex: 1, valueCallbackIndex: 3 }], a, function() { return this.getId() });
    e.createRawPropsProxy(d.prototype, []);
    ...
    d.XON_XOFF = "XON_XOFF";
    e.createPropsProxy(d, [], a);
    e.createMethodsProxy(d, [{ methodName: "enumerate", nativeName: "enumerate", persistentCallbackIndex: 0, valueCallbackIndex: 2 }], a);
    e.createPropsProxy(d, [{
        propName: "defaultInstance:getDefault:setDefault",
        propAccess: "rw",
        customSet: function(g) {
    ...
    d.getId = function() { return d.getDefaultID() };
    e.createPropsProxy(d, [{ propName: "baudRates", propAccess: "rw" }, { propName: "dataBit", propAccess: "rw" }, { propName: "flowControlMode", propAccess: "rw" }, { propName: "ParityBit", propAccess: "rw" }, { propName: "stopBit", propAccess: "rw" }, { propName: "friendlyName", propAccess: "r" }], a, function() { return this.getId() });
    e.createMethodsProxy(d, [{ methodName: "enable", nativeName: "enable", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "disable", nativeName: "disable", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "read", nativeName: "read", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "write", nativeName: "write", persistentCallbackIndex: 1, valueCallbackIndex: 3 }], a, function() { return this.getId() });
    e.createRawPropsProxy(d, []);
    e.namespace(b, d)
})(Rho.jQuery, Rho, Rho.util);
(function(e, c, d) {
    ...
    d.createPropsProxy(f.prototype, [], a, function() { return this.getId() });
    d.createMethodsProxy(f.prototype, [{ methodName: "initialize", nativeName: "initialize", valueCallbackIndex: 2 }, { methodName: "close", nativeName: "close", valueCallbackIndex: 0 }, { methodName: "startTransaction", nativeName: "startTransaction", valueCallbackIndex: 0 }, { methodName: "executeSql", nativeName: "executeSql", valueCallbackIndex: 2 }, { methodName: "executeBatchSql", nativeName: "executeBatchSql", valueCallbackIndex: 1 }, { methodName: "isTableExist", nativeName: "isTableExist", valueCallbackIndex: 1 }, { methodName: "destroyTable", nativeName: "destroyTable", valueCallbackIndex: 1 }, { methodName: "destroyTables", nativeName: "destroyTables", valueCallbackIndex: 1 }, { methodName: "commitTransaction", nativeName: "commitTransaction", valueCallbackIndex: 0 }, { methodName: "rollbackTransaction", nativeName: "rollbackTransaction", valueCallbackIndex: 0 }, { methodName: "lockDb", nativeName: "lockDb", valueCallbackIndex: 0 }, { methodName: "unlockDb", nativeName: "unlockDb", valueCallbackIndex: 0 }], a, function() { return this.getId() });
    d.createRawPropsProxy(f.prototype, []);
    d.createPropsProxy(f, [], a);
    d.createMethodsProxy(f, [], a);
    d.namespace(b, f)
...
(function(f, d, e) {
    ...
    c.OUTPUT_FORMAT_DATAURI = "dataUri";
    c.OUTPUT_FORMAT_IMAGE = "image";
    e.createPropsProxy(c, [{ propName: "compressionFormat", propAccess: "rw" }, { propName: "outputFormat", propAccess: "rw" }, { propName: "fileName", propAccess: "rw" }, { propName: "border", propAccess: "rw" }, { propName: "penColor", propAccess: "rw" }, { propName: "penWidth", propAccess: "rw" }, { propName: "bgColor", propAccess: "rw" }, { propName: "left", propAccess: "rw" }, { propName: "top", propAccess: "rw" }, { propName: "width", propAccess: "rw" }, { propName: "height", propAccess: "rw" }], a);
    e.createMethodsProxy(c, [{ methodName: "takeFullScreen", nativeName: "takeFullScreen", persistentCallbackIndex: 1, valueCallbackIndex: 3 }, { methodName: "show", nativeName: "show", valueCallbackIndex: 1 }, { methodName: "capture", nativeName: "capture", persistentCallbackIndex: 0, valueCallbackIndex: 2 }, { methodName: "clear", nativeName: "clear", valueCallbackIndex: 0 }, { methodName: "hide", nativeName: "hide", valueCallbackIndex: 0 }, { methodName: "setVectorCallback", nativeName: "setVectorCallback", persistentCallbackIndex: 0, valueCallbackIndex: 2 }], a);
    e.namespace(b, c)
})(Rho.jQuery, Rho, Rho.util);
(function(e, c, d) {
    var b = "Rho.Battery";
...
(function(e, c, d) {
    ...
    d.createRawPropsProxy(f.prototype, []);
    d.createPropsProxy(f, [], a);
    d.createMethodsProxy(f, [{ methodName: "showStates", nativeName: "showStates", valueCallbackIndex: 1 }, { methodName: "hideStates", nativeName: "hideStates", valueCallbackIndex: 0 }], a);
    d.namespace(b, f)
})(Rho.jQuery, Rho, Rho.util);
(function(e, c, d) {
...
(function(f, d, e) {
    ...
    e.createMethodsProxy(c, [{ methodName: "captureKey", nativeName: "captureKey", persistentCallbackIndex: 2, valueCallbackIndex: 4 }, { methodName: "remapKey", nativeName: "remapKey", valueCallbackIndex: 2 }, { methodName: "captureTrigger", nativeName: "captureTrigger", persistentCallbackIndex: 0, valueCallbackIndex: 2 }], a);
    e.namespace(b, c)
})(Rho.jQuery, Rho, Rho.util);
(function(f, c, d) {
    var b = "Rho.Application";
    var a = d.apiReqFor(b);
    var e = {};
    d.createPropsProxy(Rho.Application, [{ propName: "defaultNativeMenu", propAccess: "r", customGet: function() { return [{ label: "Home", action: "home" }, { label: "Refresh", action: "refresh" }, { label: "Sync", action: "sync" }, { label: "Settings", action: "options" }, { label: "Log", action: "log" }, { label: "separator", action: "" }, { label: "Exit", action: "close" }] } }], a);
        ...
        if (applicationEvent == Rho.Application.APP_EVENT_UICREATED) {
            ...
            if (Rho.System.platform != Rho.System.PLATFORM_WP8) {
                ...
                if (Rho.Application.securityTokenNotPassed) {
                    if (invalid_security_token_start_path && invalid_security_token_start_path.length() > 0) { start_url = invalid_security_token_start_path } else {
            ...
            if (applicationEvent == Rho.Application.APP_EVENT_UIDESTROYED) { console.log("AppEvent: " + applicationEvent) } else {
                if (applicationEvent == Rho.Application.APP_EVENT_CONFIGCONFLICT) { console.log("AppEvent: " + applicationEvent) } else {
                    if (applicationEvent == Rho.Application.APP_EVENT_DBMIGRATESOURCE) {
                        ...
                        return true
                    } else { if (applicationEvent == Rho.Application.APP_EVENT_SYNCUSERCHANGED) { Rho.ORM.databaseFullReset(false, false) } }
                }
            }
        }
    }
    var e = { processApplicationEvent: function(h) { g(h) } };
...
(function(d, a, b) {
    ...
    Rho.NewORM.getModel = function(e) { return Rho.NewORMModel.getModel(e) };
    Rho.NewORMModel.prototype._normalize_complex_conditions = function(f, j) {
        ...
        if (Object.prototype.toString.call(f) === "[object Array]") {
            ...
            for (var e in f) {
                if (h.length > 0) { h += " " + j + " " }
                if (e.hasOwnProperty("conditions")) { var g = this._normalize_complex_conditions(e.conditions, e.op) } else { var g = this._normalize_hash_condition(e, "AND") }
                h += "(" + g[0] + ")";
                i = i.concat(g[1])
            }
            return [h, i]
        } else { return this._normalize_hash_condition(f, j) }
    };
    ...
    Rho.NewORMModel.prototype._normalize_conditions = function(g, f, h) { if (!h) { var e; if (!f) { e = this.buildSimpleWhereCond(g, []); return [e[0], e.slice(1)] } else { if (Object.prototype.toString.call(f) === "[object String]") { e = this.buildSimpleWhereCond(g, [f]); return [e[0], e.slice(1)] } else { if (Object.prototype.toString.call(f) === "[object Array]") { e = this.buildSimpleWhereCond(g, f); return [e[0], e.slice(1)] } else { return this._normalize_complex_conditions(f, "AND") } } } } return this._normalize_complex_conditions(f, h) };
    Rho.NewORMModel.prototype._normalize_args_for_find = function(l, n, k, e) {
        var f = this.buildFindLimits(l, n);
        for (var m in f) { k[m] = f[m] }
        var h = n.orderdir || [];
        var g = n.order || [];
        if (Object.prototype.toString.call(h) === "[object String]") { h = [h] }
        if (Object.prototype.toString.call(g) === "[object String]") { g = [g] }
        e.order = this.buildFindOrder(g, h);
        var j = n.select || [];
        if (Object.prototype.toString.call(n.conditions) === "[object String]") { j = [j] }
        e.select = j;
    ...
    Rho.NewORMModel.prototype.find = function(l, n) {
        ...
        if (this.fixed_schema) {
            ...
            k.op = n.op || "AND";
            if (Object.prototype.toString.call(n.conditions) === "[object Object]") { h = this.findObjectsPropertyBagByCondHash(l, n.conditions, k, j) } else {
    ...
    Rho.NewORMModel.prototype.findBySql = function(f) { var e = this.find_by_sql(f); return this._wrapORMInstances(e) };
    ...
    Rho.NewORMModel.prototype.delete_all = function(f) {
        var f = f || {};
        if (f.conditions == undefined) { f.conditions = {} }
        if (this.fixed_schema) {
            var j = {};
            var e = {};
            ...
            e.op = f.op || "AND";
            if (Object.prototype.toString.call(f.conditions) === "[object Object]") { return this.deleteObjectsPropertyBagByCondHash(f.conditions, e) } else {
                var i = f.conditions || [""];
                var k = [];
    ...
    Rho.NewORMModel.prototype.deleteAll = function(e) { return this.delete_all(e) };
    Rho.NewORMModel.prototype._wrapORMInstance = function(e) { if (!e) { return undefined } var f = new c(this, e); return f };
    ...
    Rho.NewORMModel.prototype.make = function(e) { var f = new c(this, this.createInstance(e)); return f };
    Rho.NewORMModel.prototype.count = function() { return this.getCount() };
    Rho.NewORMModel.prototype.create = function(e) { var f = new c(this, this.createObject(e)); return f };
    var c = function(e, g) {
        for (var f in g) { this[f] = g[f] }
        this.source_id = e.source_id;
        Object.defineProperty(this, "_klass_model", { value: function() { return e }, enumerable: false });
        Object.defineProperty(this, "vars", { value: function() { var i = {}; for (var h in this) { i[h] = this[h] } return i }, enumerable: false });
        Object.defineProperty(this, "get", { value: function(h) { return this[h] }, enumerable: false });
        Object.defineProperty(this, "has", { value: function(h) { return this.hasOwnProperty(h) }, enumerable: false });
        Object.defineProperty(this, "set", { value: function(i, h) { this[i] = h; return this }, enumerable: false });
        Object.defineProperty(this, "updateAttributes", { value: function(h) { var j = this._klass_model().updateObject(this.object, this, h); for (var i in j) { this[i] = j[i] } return this }, enumerable: false });
        Object.defineProperty(this, "update_attributes", { value: function(h) { var j = this._klass_model().updateObject(this.object, this, h); for (var i in j) { this[i] = j[i] } return this }, enumerable: false });
        Object.defineProperty(this, "save", { value: function() { var i = this._klass_model().saveObject(this.object, this); for (var h in i) { this[h] = i[h] } return this }, enumerable: false });
        Object.defineProperty(this, "destroy", { value: function() { this._klass_model().deleteObject(this.object); return this }, enumerable: false })
    };
    ...
    Rho.NewORM.getDbPartitions = function() { return Rho.NewORM.dbPartitions };
    Rho.NewORM.clear = function() { Rho.NewORMModel.clear() };
